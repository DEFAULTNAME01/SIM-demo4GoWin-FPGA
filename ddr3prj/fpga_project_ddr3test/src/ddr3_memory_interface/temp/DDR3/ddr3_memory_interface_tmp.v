...
//Device: GW5A-25
//Device Version: A
//Created Time: Sun Mar  8 09:47:34 2026
...
//--------Copy here to design--------
	...
	DDR3_Memory_Interface_Top your_instance_name(
		...
		.dbg_vector4_out(dbg_vector4_out), //output [15:0] dbg_vector4_out
		.dbg_vector3_out(dbg_vector3_out), //output [5:0] dbg_vector3_out
		.dbg_vector2_out(dbg_vector2_out), //output [7:0] dbg_vector2_out
		.dbg_vector1_out(dbg_vector1_out), //output [7:0] dbg_vector1_out
